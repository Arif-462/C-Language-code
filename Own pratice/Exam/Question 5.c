/* 5. Let us create a new version of weird algorithm. You will be given an integer, n as input. If n is even, divide it by two.
...
int main()
{
    ...
    while(n>1)
    {
        printf("%d, ",n);// (3n+1)and(n-1) formula in c programe
        if (n % 2 == 0)
        {
            n = n/2;
        }
